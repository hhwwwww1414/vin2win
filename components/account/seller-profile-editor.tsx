    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogPortal>
        ...
        <DialogPrimitive.Content
          className="fixed inset-2 z-50 flex flex-col overflow-hidden rounded-[28px] border border-border/70 bg-card p-0 shadow-[0_28px_80px_rgba(0,0,0,0.32)] duration-200 focus:outline-none sm:inset-auto sm:left-1/2 sm:top-1/2 sm:max-h-[90vh] sm:w-[calc(100vw-2.5rem)] sm:max-w-[1180px] sm:-translate-x-1/2 sm:-translate-y-1/2 lg:max-h-[92vh]"
        >
