...
export function SellerProfileEditor({ sellerProfile, onSaved, children }: SellerProfileEditorProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogPortal>
        <DialogOverlay />
        <div className="fixed inset-0 z-50 flex items-stretch justify-stretch p-2 sm:items-center sm:justify-center sm:p-6">
          <DialogPrimitive.Content className="relative flex h-full w-full flex-col overflow-hidden rounded-[28px] border border-border/70 bg-card p-0 shadow-[0_28px_80px_rgba(0,0,0,0.32)] duration-200 focus:outline-none sm:h-auto sm:max-h-[92vh] sm:max-w-[1180px]">
            <DialogClose className="absolute top-4 right-4 z-20 flex h-10 w-10 items-center justify-center rounded-2xl border border-border/70 bg-background/80 text-muted-foreground transition-colors hover:border-teal-accent/35 hover:text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background">
              <XIcon className="h-5 w-5" />
              <span className="sr-only">Close</span>
            </DialogClose>

            <DialogHeader className="shrink-0 border-b border-border/70 px-5 py-5 pr-16 sm:px-6">
                  ...
                  <div className="grid gap-4 rounded-3xl border border-border/70 bg-background/60 p-4">
                    <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
                      ...
                      <Input
                        ...
                        className="w-full xl:max-w-[260px]"
                      />
                    </div>
                    ...
                    <div className="relative px-5 pb-5">
                      <div className="-mt-10 flex items-end gap-4">
                        ...
                        <div className="min-w-0 pb-1">
                          <p className="truncate text-sm font-semibold text-foreground">{form.name || 'Имя продавца'}</p>
